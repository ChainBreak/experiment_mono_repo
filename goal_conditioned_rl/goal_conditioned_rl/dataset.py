...
# Each __iter__ call yields an endless stream of (current, goal) pairs sampled
# randomly from the recorded episodes. The frame filenames encode their
...
class TransitionDataset(IterableDataset):
    def __init__(self, data_directory: str):
        ...
        self.episodes: list[list[pathlib.Path]] = []
        self.refresh()
    ...
    def __iter__(self):
        while True:
            episode_frames = random.choice(self.episodes)
